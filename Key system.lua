...
_G.Key = "DEV-33W0-R0Y2-CMPY-Q57C"
...
if isfile("axelhub_assa_key.key") then
delfile("axelhub_assa_key.key")
    end
...
if yes == true then
loadstring(game:HttpGet("https://raw.githubusercontent.com/YOZEE56/YOZEE/main/Aas"))()
        end
end
